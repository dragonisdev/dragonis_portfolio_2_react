  ...
  return (
    <div className='links '>
      <div className={`${styles.flexCenter}  flex flex-col flex-wrap sm:mb-22 sm:mb-6 mb-0 `}>
        <div>
          <img src={line}  className=' pt-8 px-6 pl-0 text-center items-center '/>
        </div>

        <div className='backdrop-blur-md flex flex-row flex-wrap  max-w-[100%] md:space-x-14 ss:space-x-10 '>
        {socials.map((socials) => (
