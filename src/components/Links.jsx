    ...
    <div className='links'>
      <div className={`${styles.flexCenter}  flex flex-col flex-wrap x sm:mb-6 mb-0 `}>
        ...
        {socials.map((socials, i) => (
          ...
          <img key={i} src={`${socials.img}`} href={`${socials.link}`} className={`w-10 min-w-0 scale-75 icons flex-1 flex justify-start items-center flex-row my-2 mx-0 px-1`} style={{objectFit: 'contain'}} onClick={() => window.open(`${socials.link}`,'_blank')}/>
